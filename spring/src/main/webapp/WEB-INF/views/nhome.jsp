<%@page import="com.spring.prolog.database.Database"%>
...
<body>
	...
	<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
		<div class="navbar-header">
            ...
            <a class="navbar-brand" href="<c:url value='/home'/>" style="font-weight: bold;" id="prolog-logo"><i class="fa fa-pinterest-p" aria-hidden="true"></i>ro|Log</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="background-color: #ededed;">
			<ul class="nav navbar-nav navbar-right" style="padding-right: 20px;">
				<li>
				    ...
				    %>
				    	<a class="page-scroll style-home-menu" href="<c:url value='/home'/>" >LOGIN</a>
				    <%
					}
				    ...
				    <%
				  	  	...
				  	  	DBConnection.setDBNAME(dbN[0]);
				  	%>
				  		<a class="page-scroll style-home-menu" href="<c:url value='/alert'/>" >ALERT</a>
				  	</li>
				  	<li>
				  		<a class="page-scroll style-home-menu" href="<c:url value='/logout'/>">LOGOUT</a>
				  	<%
					}
      ...
      if(loginEmail != null){
      	String dbEmail = request.getParameter("loginEmail");
    	  ...
    	  DBConnection.setDBNAME("test");
                ...
                <li>
                	<a class="page-scroll style-home-menu" href="<c:url value='#home'/>">Home</a>
                </li>
                <li>
                	<a class="page-scroll style-home-menu" href="<c:url value='#services'/>">Services</a>
               	</li>
                <li>
                    <a class="page-scroll style-home-menu" href="<c:url value='#developers'/>">Developers</a>
                </li>
                </ul>
		</div>
	</nav>
	...
	<section id="home" style="padding: 50px 0px;">
		<header id="top" class="header">
			<div class="text-vertical-center">
	            ...
	            <br>
	           <form name="form" method="post" enctype="multipart/form-data" action="<c:url value='/dashboard'/>">
		...
		<div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <hr class="primary" style="border-color: #337ab7;border-width: 3px;max-width: 50px;"/>
                </div>
            </div>
        </div>
        <div class="container">
            ...
            <div class="row no-gutter popup-gallery">
                ...
                <div class="col-lg-4 col-sm-6">
                    <a href="<c:url value='/resources/img/portfolio/fullsize/5.png'/>" class="portfolio-box">
                        <img src="<c:url value='/resources/img/portfolio/thumbnails/5.png'/>" class="img-responsive" alt="" >
                        <div class="portfolio-box-caption">
                            <div class="portfolio-box-caption-content">
                                <div class="project-category text-faded">
                                    MADE BY
    ...
    $(function() {
        $('a[href*=#]:not([href=#],[data-toggle],[data-target],[data-slide])').click(function() {
            if (location.pathname.replace(/^\//, '') == this.pathname.replace(/^\//, '') || loaction.hostname == this.hostname) {
