...
public class SummaryActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private int[] yValues = {0, 0, 0, 0, 0, 0};
    private int[] yValues1 = {10, 10, 10, 10, 10, 10};
    private String[] xValues = {"SQL Injection", "Directory Listing", "LFI & RFI", "Scanning", "Web CGI", "Pattern Block"};

    // colors for different sections in pieChart
    public static  final int[] MY_COLORS = {
            Color.rgb(173, 116, 96)
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChart = (RadarChart) findViewById(R.id.rader);
    ...
    public void setDataForRadarChart() {
        ...
        // create pieDataSet
        RadarDataSet dataSet = new RadarDataSet(yVals1, "");
        ...
        dataSet.setFillColor(MY_COLORS[0]);
