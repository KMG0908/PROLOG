...
/*	        Paragraph number2=new Paragraph();
            ...
            top = AttackyValues[0];
            middle = AttackyValues[1] + AttackyValues[2];
            bottom = AttackyValues[3] + AttackyValues[4] + AttackyValues[5];
           /* try{
            ...
            Paragraph p14=new Paragraph("   √  전체 로그 " + checkedLog + "개 중 위험 2단계 " + da2 + "개, 위험 1 단계 " + da1 + "개가 발견되었습니다.\n\n   √  예상 피해 정도는 상 " + topP + "%, 중 " + middleP + "% 그리고 하 " + bottomP + "% 입니다.\n",font);
