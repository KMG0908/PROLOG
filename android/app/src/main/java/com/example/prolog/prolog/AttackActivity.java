...
public class AttackActivity extends AppCompatActivity {
    ...
    public static  final int[] MY_COLORS = {
            Color.rgb(173, 116, 96), Color.rgb(136, 56, 45), Color.rgb(168, 74, 92), Color.rgb(214, 163, 84), Color.rgb(239, 185, 143), Color.rgb(202, 167, 155)
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChart = (PieChart) findViewById(R.id.attack);
